...
async def chat_queshi(bot, ev):
    if random.random() < 0.05:
        await bot.send(ev, R.img("keyword/确实.jpg").cqcode)

@sv.on_keyword(('内鬼'))
async def chat_neigui(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/内鬼.png").cqcode)
        
@sv.on_keyword(('不要以为这样就赢了'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/不要以为这样就赢了.jpg").cqcode)
                     
@sv.on_keyword(('上流', '上流社会', '红酒'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/上流.jpg").cqcode)
        
@sv.on_keyword(('真行', '彳亍'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/行.jpg").cqcode)
       
@sv.on_keyword(('别肝啦', '别肝了', '求求你们别肝了'))
async def chat_clanba(bot, ev):
    if random.random() < 0.30:
        await bot.send(ev, R.img("keyword/别肝啦.jpg").cqcode)
        
@sv.on_keyword(('lsp', '老色批'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/lsp.jpg").cqcode)        
       
@sv.on_keyword(('爬', '爪巴'))
async def chat_clanba(bot, ev):
    if random.random() < 0.05:
        await bot.send(ev, R.img("keyword/爬.jpg").cqcode)   

@sv.on_keyword(('不会吧'))
async def chat_clanba(bot, ev):
    if random.random() < 0.02:
        await bot.send(ev, R.img("keyword/不会吧.jpg").cqcode)
        
@sv.on_keyword(('mana', '玛娜'))
async def chat_clanba(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/mana.jpg").cqcode)
        
@sv.on_keyword(('整一个', '白嫖'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/整一个.png").cqcode)

@sv.on_keyword(('正道的光'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/正道的光.jpg").cqcode)
        
@sv.on_keyword(('好臭啊', '野兽先辈'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/臭.jpg").cqcode)
        
@sv.on_keyword(('我超勇的'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/勇.jpg").cqcode)
        
@sv.on_keyword(('你不对劲', '不对劲'))
async def chat_clanba(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/不对劲.jpg").cqcode)
        
@sv.on_keyword(('respect', '尊重'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/res.jpg").cqcode)
        
@sv.on_keyword(('晒卡', '我出货啦', '我中了', '我出了'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/gacha.jpg").cqcode)
        
@sv.on_keyword(('死机', '错误', 'error'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/错误.jpg").cqcode)
        
@sv.on_keyword(('芜湖', '起飞', '飞飞飞'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/飞.jpg").cqcode)
                       
@sv.on_keyword(('你有问题'))
async def chat_clanba(bot, ev):
    if random.random() < 0.02:
        await bot.send(ev, R.img("keyword/123.jpg").cqcode)

@sv.on_keyword(('box', '角色练度'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/box.jpg").cqcode)

@sv.on_keyword(('钻石', '宝石', '挖矿'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/宝石.jpg").cqcode)

@sv.on_keyword(('布丁'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/布丁.gif").cqcode)

@sv.on_fullmatch(('我能去你家吃饭嘛', '我能去你家吃饭吗'))
async def chat_clanba(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/吃饭吃一勺.jpg").cqcode)
#=================#
...
async def chat_clanba(bot, ev):
    if random.random() < 0.30:
        await bot.send(ev, R.img("keyword/小仓唯.jpg").cqcode)

@sv.on_keyword(('不太好吧'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/不太好.jpg").cqcode)

@sv.on_keyword(('零花钱'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/零花钱.jpg").cqcode)

@sv.on_keyword(('伊利亚'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/伊利亚.jpg").cqcode)

@sv.on_keyword(('伊莉雅', 'yly'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/伊莉雅.jpg").cqcode)

@sv.on_fullmatch(('牙白', '牙白的死呐', '厉害了啊', '牙白得死呐'))
async def chat_clanba(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/牙白.jpg").cqcode)

@sv.on_keyword(('遇到困难', '遇到困难睡大觉'))
async def chat_clanba(bot, ev):
    if random.random() < 0.30:
        await bot.send(ev, R.img("keyword/遇到困难.jpg").cqcode)

@sv.on_keyword(('云里雾里', '懵', '不懂'))
async def chat_clanba(bot, ev):
    if random.random() < 0.15:
        await bot.send(ev, R.img("keyword/云里雾里.jpg").cqcode)

@sv.on_keyword(('咕噜凌波', '咕噜灵波'))
async def chat_clanba(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/咕噜灵波.jpg").cqcode)

@sv.on_keyword(('甜心刀'))
async def chat_clanba(bot, ev):
    if random.random() < 0.10:
        await bot.send(ev, R.img("keyword/甜心刀教程.jpg").cqcode)
...
async def chat_uesorry(bot, ev):
    if random.random() < 0.20:
        await bot.send(ev, R.img("keyword/对不起.jpg").cqcode)